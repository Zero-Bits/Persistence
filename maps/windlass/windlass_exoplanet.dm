/obj/effect/overmap/visitable/sector/exoplanet/windlass
	name = "\improper Windlass"
	desc = "A dessicated colony, home to those unwelcome elsewhere."
	planetary_area = /area/exoplanet/windlass
	daycycle = 25 MINUTES
...
/obj/effect/overmap/visitable/sector/exoplanet/windlass/Initialize(var/mapload, var/z_level)
...
/obj/effect/overmap/visitable/sector/exoplanet/windlass/update_daynight()
	var/light = 0.05
	if(!night)
		light = 0.5
...
/obj/effect/overmap/visitable/sector/exoplanet/windlass/generate_habitability()
	habitability_class = HABITABILITY_BAD

/obj/effect/overmap/visitable/sector/exoplanet/windlass/get_atmosphere_color()
	return COLOR_GREEN_GRAY

/obj/effect/overmap/visitable/sector/exoplanet/windlass/generate_atmosphere()
	atmosphere = new
