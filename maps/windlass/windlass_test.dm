/datum/map/windlass
	...
	// Hotloading module
	default_levels = list(
		"1" = "maps/windlass/windlass-1.dmm",
		"2" = "maps/windlass/windlass-2.dmm",
		"3" = "maps/windlass/windlass-3.dmm",
		"4" = "maps/windlass/windlass-4.dmm"
	)
	...
	default_levels = list(
		"4" = "maps/windlass/windlass-1.dmm",
		"5" = "maps/windlass/windlass-2.dmm",
		"6" = "maps/windlass/windlass-3.dmm",
		"7" = "maps/windlass/windlass-4.dmm"
	)
